...
import { AreaChart, Area, CartesianGrid, Tooltip, XAxis, YAxis, ResponsiveContainer, PieChart, Pie, Cell, Legend} from 'recharts';
import Heading
 from "../../ui/Heading";
  ...
  return (
    <ChartBox>
      ...
      <ResponsiveContainer width="100%" height={240}>
        <PieChart>
          <Pie data={data} nameKey='duration' dataKey='value' innerRadius={85} outerRadius={120} cx="40%" cy="50%" paddingAngle={3}>
